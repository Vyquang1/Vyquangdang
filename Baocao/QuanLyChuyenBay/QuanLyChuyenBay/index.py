...
def details(lich_chuyen_bay_id):
    lcb = dao.chi_tiet_lich_chuyen_bay(lich_chuyen_bay_id)
...
def addinformation(lich_chuyen_bay_id, sove):
    cb = dao.load_chuyen_bay()
    lich_chuyen_bay = dao.chi_tiet_lich_chuyen_bay(lich_chuyen_bay_id)
...
@app.route('/cus_information/chuyen_bay_<int:lich_chuyen_bay_id>')
def cus(lich_chuyen_bay_id):
    cb = dao.load_chuyen_bay()
    sove = request.args.get("Soluongve")
    lich_chuyen_bay = dao.chi_tiet_lich_chuyen_bay(lich_chuyen_bay_id)
    # print(json.dumps(lich_chuyen_bay, indent=4, ensure_ascii=False))
    print(lich_chuyen_bay.price)
    tongtien = int(lich_chuyen_bay.price) * int(sove)
    return render_template("cus_information.html", sove=int(sove), cb=cb, chuyen_bay_id=lich_chuyen_bay.chuyen_bay_id,
